<nav class="flex items-center gap-4">
    <button onclick="whatsapp()" type="button" data-bs-toggle="tooltip" title="Whatsapp"
        class="w-10 aspect-square flex items-center justify-center rounded-xl bg-sky-500 hover:bg-sky-600 text-white">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            class="bi bi-whatsapp size-6" viewBox="0 0 16 16">
            <path
    ...
    <button onclick="twitter()" type="button" data-bs-toggle="tooltip" title="twitter"
        class="w-10 aspect-square flex items-center justify-center rounded-xl bg-sky-500 hover:bg-sky-600 text-white">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            class="bi bi-twitter-x size-6" viewBox="0 0 16 16">
            <path
    ...
    <button onclick="telegram()" type="button" data-bs-toggle="tooltip" title="telegram"
        class="w-10 aspect-square flex items-center justify-center rounded-xl bg-sky-500 hover:bg-sky-600 text-white">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            class="bi bi-telegram size-6" viewBox="0 0 16 16">
            <path
    ...
    <button onclick="copyLink(this)" type="button" data-bs-toggle="tooltip" title="Copy"
        class="w-10 aspect-square flex items-center justify-center rounded-xl bg-sky-500 hover:bg-sky-600 text-white">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            class="bi bi-share size-6" viewBox="0 0 16 16">
            <path
