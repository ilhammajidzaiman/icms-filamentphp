                ...
                Section::make(Str::title(__('form')))
                    ...
                    ->schema([
                        ...
                        Radio::make('type')
                            ...
                            ->inline()
                            ->inlineLabel(false),
                        Textarea::make('file_text')
                            ->label(Str::title(__('text')))
                            ->visible(fn(callable $get): bool => $get('type') === SettingSiteTypeEnum::Text->value)
                            ->autosize(),
                        FileUpload::make('file_file')
                            ->label(Str::title(__('file')))
                            ->helperText(Str::title(__('max: 10 mb.')))
                            ->visible(fn(callable $get): bool => $get('type') === SettingSiteTypeEnum::File->value)
