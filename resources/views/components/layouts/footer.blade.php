                ...
                <div class="col-span-full md:col-span-4 space-y-8">
                    <div class="flex justify-center md:justify-start items-center">
                        <div class="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4">
                            <div
                                class="font-bold text-4xl text-center bg-linear-to-r from-sky-500 to-slate-100 bg-clip-text text-transparent">
                                {{ $siteSetting->name ?? env('APP_NAME') }}
                            </div>
                            <div class="h-1 w-full md:self-stretch md:w-1 md:h-auto bg-white rounded-xl">
                            </div>
                            <div
                                class="flex flex-row md:flex-col flex-wrap justify-center md:justify-start md:items-start gap-2 md:gap-0 font-medium  text-center md:text-left text-white ">
                                @foreach (explode(' ', $siteSetting->tagline ?? null) as $item)
                                    <span>{{ $item ?? null }}</span>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="space-y-2">
                        @php
                            $address = [
                                (object) [
                                    'title' => 'Jalan Utama, Pekanbaru, Riau, Indonesia',
                                    'file' =>
